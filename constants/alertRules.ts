...
const SELL_RULES: AlertRule[] = [
  ...
  {
    id: 'weinstein-150-break',
    name: '와인스타인 150일선 이탈',
    description: '주가가 30주(150일) 이평선을 하향이탈 — 와인스타인 매도 기준',
    severity: 'warning',
    action: 'sell',
    enabled: true,
    filters: ['PRICE_CROSS_BELOW_MA'],
    filterConfig: { maCrossPeriod: 150, withinDays: 5 },
  },
  {
    id: 'ma120-break',
    name: '120일선 이탈',
    description: '주가가 120일 이평선을 하향이탈 — 중기 추세 붕괴',
    severity: 'warning',
    action: 'sell',
    enabled: true,
    filters: ['PRICE_CROSS_BELOW_MA'],
  ...
  },
  {
    id: 'swing-low-break',
    name: '직전 저점 이탈',
    description: '주가가 최근 형성된 저점 아래로 떨어짐 — 상승 추세 종료 신호(와인스타인)',
    severity: 'warning',
    action: 'sell',
    enabled: true,
    filters: ['SWING_LOW_BREAK'],
    filterConfig: {},
  },
];
