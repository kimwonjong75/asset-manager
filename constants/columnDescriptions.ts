export const COLUMN_DESCRIPTIONS: Record<string, string> = {
  ...
  returnPercentage: '(평가총액 - 투자원금) ÷ 투자원금 × 100\n클릭 시 수익률 ↔ 평가손익(원) 전환\n\n해외 종목은 설정 > 표시 설정 > 수익률 기준에 따라\n달러 기준(환율 변동 제외) 또는\n원화 기준(환율 손익 포함)으로 계산됩니다',
  profitLossKRW: '평가총액 - 투자원금 (KRW 표시)\n클릭 시 평가손익 ↔ 수익률(%) 전환\n\n해외 종목의 환율 반영 방식은\n설정 > 표시 설정 > 수익률 기준을 따릅니다',
  purchaseValue: '매수평균가 × 보유수량 (KRW 환산)\n해외 종목은 설정 > 표시 설정 > 수익률 기준에 따라\n오늘 환율 또는 매수 당시 환율로 환산됩니다',
  ...
  turtleExitGapPct: '(종가 - 청산선) ÷ 청산선 × 100\n청산선은 터틀 규칙의 20일 최저가(설정 가능)\n음수면 이미 청산선 아래로 마감(팔 때)',
  turtleStatus: '"보유종목 터틀" 상태\n보유 유지 · 팔 때 · 감시 중 · 다시 살 때 · 추가 매수 · 확인 불가 · 범위 제외\n계산 근거는 홈 "터틀 오늘 할 일" 카드에서 확인하세요',
};
