  ...
  return (
    <div className="bg-gray-800 rounded-lg p-3">
      <h3 className="text-sm font-bold text-white mb-1 flex items-center gap-2 flex-wrap">
        ...
        {edge && (
          <span className={`text-xs px-1.5 py-0.5 rounded border ${edge.cls}`}>{edge.label}</span>
        )}
      </h3>
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            ...
            <Stat
              ...
              valueClass={
                diag.expectancy == null ? 'text-gray-500' : diag.expectancy >= 0 ? 'text-up' : 'text-down'
              }
            />
          </div>
          ...
          <p className="text-xs text-gray-500 mt-2 pt-2 border-t border-gray-700/40">
