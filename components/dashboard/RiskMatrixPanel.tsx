                    ...
                    >
                      <span className="flex items-center gap-1 min-w-0 overflow-hidden">
                        {row.source === 'watchlist' && (
                          <span className="text-xs px-1 py-0.5 rounded whitespace-nowrap bg-teal-600/30 text-teal-400 font-medium shrink-0">관심</span>
                        )}
                        <span className="text-white truncate">{row.assetName}</span>
                        <span className="text-gray-500 text-xs shrink-0">{row.ticker}</span>
                      </span>
