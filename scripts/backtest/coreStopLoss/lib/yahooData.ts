// scripts/backtest/coreStopLoss/lib/yahooData.ts
// 코어 손절 연구 Gate 0 데이터 계층 — 연구 전용(앱/백엔드 무접촉).
// sectorRotation/lib/yahooData.ts 와 동일한 패턴이며, 캐시만
// scripts/backtest/coreStopLoss/cache/ 로 분리한다.
