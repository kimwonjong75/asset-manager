// scripts/backtest/portfolioTurtle/configHash.ts
// 동결 설정 정규화 SHA-256 — 기존 PREREG 규약(재귀 키정렬 → 무공백 stringify → SHA-256)과 동일.
// holdingsTurtleCycle/freshTurtleLifecycle의 configHash.ts와 동일 패턴(폴더별 자기완결 사본).
